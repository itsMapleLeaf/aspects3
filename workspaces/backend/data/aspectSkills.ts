...
export function listAspectSkills(): AspectSkill[] {
	return Array.from(aspectSkills.values())
}

export function getAspectSkill(name: string): AspectSkill | undefined {
	return aspectSkills.get(name)
}
