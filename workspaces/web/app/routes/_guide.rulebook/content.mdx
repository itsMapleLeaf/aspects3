...
Every character has a base score for each Aspect from 0 to 6, adding to a sum depending on your [level](#levels--progression). Then add the character's score for the aspect's linked attribute to get the aspect's total score.
...
Example: you want to use _Shield_, which is a water aspect art. If your total water score is 7 (Base 3 + Sense 4), you would need to roll a 7 or lower to succeed.
