...
1. For each [attribute](#attributes) choose a value from 1 to 6. They should add up to 18.
1. For each [aspect](#aspects), choose a value from 0 to 6. They should add up to 6.
...
Attributes represent your character's core strengths of various capabilities or domains. Each player character should have a score for each attribute from 1 to 6. They should all add to 18.
...
Every character has a base score for each Aspect from 0 to 6. They should add to 6. The total aspect score is the sum of the character's attribute score and their aspect score.
...
Your character's **attuned** aspects are those with a base score of one or more. For example: if you assign 4 points to darkness and 2 points to water, you have two attuned aspects: darkness and water. Fire, light, and wind are unattuned.
...
In this case, your combination of tratits let you pick one proficiency in every attribute, except for Agility, which gives you _2 proficiencies_, due to the overlap from your wings and tail!
